...
opt_parser = OptionParser.new do |opt|
  opt.banner = "Usage: ityran COMMAND [OPTIONS]"
  opt.separator  ""
  opt.separator  "Commands"
  opt.separator  "     init     : init resources dir"
  opt.separator  "     build    : build and create pdf and html docs"
  opt.separator  "     clean    : clear no use resources"
  opt.separator  ""
